...
let
	...
	o_ = [ox, oy, oz]
	o = 0.35 .* o_ ./ norm(o_); v1, v2 = normals(o); display((o,v1))
...
let
	...
	splot(:unitranges, :notics, :labels, "set pm3d depthorder", "set view equal xyz", "set view 60,30", "unset colorbox", "set pm3d lighting", x, y, z, "w pm3d fillcolor 'dark-turquoise'")
end
