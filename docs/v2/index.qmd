...
Gaston's documentation also includes several [Pluto](https://plutojl.org/)
notebooks, with examples and tutorials. These are found
[here](https://github.com/mbaz/Gaston.jl/tree/master/notebooks).

## Acknowledgments

When developing Gaston, I've been inspired by the excellent features and ideas
behind other Julia plotting packages (including (Plots.jl)[], (Gnuplot.jl)[]
and (Makie.jl)[]). Many thanks to their multiple authors for freely sharing
their code and their APIs!
